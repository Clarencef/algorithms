...
/***/ function(module, exports, __webpack_require__) {
	...
	window.onload = function () {
	  ...
	  var harmlessRandomNoteBlock = document.getElementById('harmlessRandomNoteBlock');
	
	  fizzBuzzBlock.innerHTML = '<h2>FizzBuzzBlock</h2>' + fizzBuzzInfo;
	  harmlessRandomNoteBlock.innerHTML = (0, _harmlessRandomNote2.default)('this is this', 'this is the text of the note');
	};
